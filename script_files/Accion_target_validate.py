...
logger = get_logger("Accion_target_validate")
...
def validate_target():
    logger.info("validating the target table")
    data = get_data_table('sales.accion_sales_target')
    logger.info("target validation - success")
