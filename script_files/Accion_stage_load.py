...
logger = get_logger("Accion_stage_load")
...
def load_stage():
    logger.info("Loading the dataframe to the stage table")
    rc = get_dataframe(file)
    data = get_data_table('sales.accion_sales_stage')
    logger.info("Data loaded successfully to the stage table")
